// pages/AdicionarDespesa.js
// Componente React Native para a página "Adicionar Despesa".
...
// reutilizando a base da AdicionarReceita.js.
...
// Por simplicidade, usaremos ícones baseados em texto ou svgs simples.
...
const AdicionarDespesa = () => {
    ...
    const handleSalvarDespesa = () => {
        console.log('Despesa a ser salva:', {
            descricao,
            valor,
            data,
            categoria,
        ...
        alert('Despesa salva!'); // Use um modal personalizado em produção
        // Resetar formulário
        setDescricao('');
        setValor('');
        setData('22/05/2025');
    ...
    const handleAddAnexo = () => {
        ...
        // Exemplo: setAnexoNome('recibo_supermercado.pdf');
    };
        ...
        <View style={{ flex: 1, backgroundColor: '#f3f4f6' }}> {/* Contêiner principal com fundo */}
            ...
            >
                <View style={dashboardStyles.mainBox}>
                    <Text style={styles.pageTitle}>Adicionar Despesa</Text>

                    {/* Descrição */}
                    <View style={styles.inputGroup}>
                        <Image source={require('../assets/nav.png')} style={styles.iconeStatus} />
                    ...
                    {/* Botão Salvar */}
                    <TouchableOpacity style={styles.saveButton} onPress={handleSalvarDespesa}>
...
// Estilos específicos da página AdicionarDespesa
